...
class MenuHelper
{
        ...
        return [
            [
                ...
                'subItems' => [
                    [
                        'name' => 'Manage Events',
                        'path' => route('event.eventphoto.index', absolute: false),
                        'pro'  => false,
                    ],
                    [
                        'name' => 'Manage Booking',
                        'path' => route('eventphoto.bookings.index', absolute: false),
                        'pro'  => false,
                    ]
                ],
            ],
    ...
    public static function getMenuGroups(): array
    {
        ...
        // Non-admin (only if logged in) sees My Account group
        if (Auth::check()) {
            $groups[] = [
                'title' => 'My Account',
    ...
    public static function getIconSvg($iconName): string
    {
        $icons = [
            ...
            // ADD: lock icon (needed for Change Password)
            'lock' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.75C9.37665 2.75 7.25 4.87665 7.25 7.5V10.25H6.5C5.25736 10.25 4.25 11.2574 4.25 12.5V19.5C4.25 20.7426 5.25736 21.75 6.5 21.75H17.5C18.7426 21.75 19.75 20.7426 19.75 19.5V12.5C19.75 11.2574 18.7426 10.25 17.5 10.25H16.75V7.5C16.75 4.87665 14.6234 2.75 12 2.75ZM8.75 7.5C8.75 5.70507 10.2051 4.25 12 4.25C13.7949 4.25 15.25 5.70507 15.25 7.5V10.25H8.75V7.5ZM5.75 12.5C5.75 12.0858 6.08579 11.75 6.5 11.75H17.5C17.9142 11.75 18.25 12.0858 18.25 12.5V19.5C18.25 19.9142 17.9142 20.25 17.5 20.25H6.5C6.08579 20.25 5.75 19.9142 5.75 19.5V12.5Z" fill="currentColor"/></svg>',
