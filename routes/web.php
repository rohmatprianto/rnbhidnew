...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('can:viewAny,' . User::class)->group(function () {
        ...
        Route::match(['put', 'patch'], '/users/{user}', [UserController::class, 'update'])->middleware('can:update,user')->name('users.update');
        Route::patch('/users/{user}/photo', [UserController::class, 'updatePhoto'])->middleware('can:update,user')->name('users.photo.update');
